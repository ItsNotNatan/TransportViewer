...
export default function Dashboard({ atms, carregando, onOpenAtm }) {
  ...
  return (
    <section className="fade-in section-dashboard">
      ...
      {/* RENDERIZA O FILTRO DE OPERAÇÃO DE FORMA INVISÍVEL, CONTROLADO PELO ESTADO */}
      <FiltroOP 
        atms={atms} 
        filtros={filtros} 
        onFiltroChange={handleFiltroChange} 
        onLimpar={limparFiltros} 
        aberto={abertoFiltroOp}
        onClose={() => setAbertoFiltroOp(false)}
      />
        ...
        <table className="data-table" style={{ whiteSpace: 'nowrap', width: '100%' }}>
          <thead>
            <tr style={{ backgroundColor: '#f3f4f6' }}>
              ...
              {/* COLUNA DADOS DA OPERAÇÃO */}
              <th colSpan="8" style={{ borderRight: '2px solid #e5e7eb', color: '#1e3a8a', padding: '10px' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px' }}>
                  <span style={{ fontWeight: 'bold', fontSize: '0.85rem', letterSpacing: '0.05em' }}>DADOS DA OPERAÇÃO</span>
                  
                  {/* O BOTÃO AGORA ACIONA O ESTADO: onClick={() => setAbertoFiltroOp(true)} */}
                  <button 
                    onClick={() => setAbertoFiltroOp(true)}
                    style={{ 
                      display: 'flex', alignItems: 'center', gap: '4px', 
                      backgroundColor: '#ffffff', border: '1px solid #bfdbfe', 
                      padding: '4px 8px', borderRadius: '4px', cursor: 'pointer',
                      fontSize: '0.7rem', color: '#1d4ed8', fontWeight: 'bold',
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px' }}>
                  ...
                  <button 
                    style={{ 
                      ...
                      padding: '4px 8px', borderRadius: '4px', cursor: 'pointer',
                      fontSize: '0.7rem', color: '#059669', fontWeight: 'bold',
                      boxShadow: '0 1px 2px rgba(0,0,0,0.05)'
                    }}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"></polygon></svg>
          ...
          <tbody>
            {carregando ? (
              ...
              <tr><td colSpan="17" className="text-center" style={{padding: '2rem', color: '#6b7280'}}>Nenhum resultado encontrado.</td></tr>
